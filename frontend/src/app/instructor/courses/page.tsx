  ...
  return (
    <div className="p-8 max-w-7xl mx-auto animate-fade-in">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-primary-container tracking-tight mb-2">My Courses</h1>
          <p className="text-on-surface-variant">Manage your teaching programs and content.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-outline-variant/20">
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-8 text-center text-on-surface-variant">
                    You are not assigned as an instructor to any courses yet.
                  </td>
                </tr>
              ) : (
                courses.map((course) => (
